      ...
      <div className={styles.claim}>
        {!address ? (
          ...
          <div className={styles.card}>
            ...
            <p>
              Your address ({address}) has already claimed the maximum amount of {Math.round(numTokens/100 * 10)} tokens for this vesting period.
            </p>
          </div>
        ) : (
          // Claim your airdrop
          <div className={styles.card}>
            ...
            <p>Your address qualifies for {numTokens} tokens total. This vesting phase will grant you {Math.round(numTokens/100 * 10)} tokens</p>
